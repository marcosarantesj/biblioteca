 ...
 * @author MARK
 */
public class ifrmCadLogin extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        txtSenha.setFont(new java.awt.Font("Tahoma", 0, 12));
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        if (txtNome.getText().equals("")) {
        ...
        } else if (cbNivel.getModel().getSelectedItem() == null) {
            JOptionPane.showMessageDialog(null, "Selecione o nível do usuário !",
                    "Aviso", JOptionPane.WARNING_MESSAGE);
            ...
            String senha;
            String sqlInsert = "INSERT INTO login1(nome,senha,nivel_idnivel)VALUES(?,?,?)";
            try {
                crypto = new util();
                senha = crypto.criptografaSenha(String.valueOf(txtSenha.getPassword()));
                st1 = banco.conn.prepareStatement(sqlInsert);
                st1.setString(1, txtNome.getText().trim());
                st1.setString(2, senha);
                st1.setInt(3, ((Niveis) cbNivel.getSelectedItem()).getCodigo());
...
//            PreparedStatement st1 = null;
//            String sqlInsert = "UPDATE login1 SET nome=?,senha=? WHERE codigo=?";
//            try {
//                st1 = banco.conn.prepareStatement(sqlInsert);
//                st1.setString(1, txtNome.getText().trim());
//                st1.setInt(2, Integer.parseInt(txtCodigo.getText().trim()));
//                st1.setString(3, String.valueOf(txtSenha.getPassword()));
...
//        } else if (jTable1.getRowCount() > 1) {
//            lblMensagem.setText(jTable1.getRowCount() + " registros encontrados !");
//        }
    ...
    private void btnTodosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTodosActionPerformed
        DB banco = new DB();
        banco.connect();
        Query c = new Query(banco.conn);
        String sql = null;
        if (rdAsc.isSelected()) {
            sql = "SELECT codigo,nome,nivel_idnivel FROM login1 ORDER BY nome ASC";
        } else {
            sql = "SELECT codigo,nome,nivel_idnivel FROM login1 ORDER BY nome DESC";
        }
        c.open(sql);
        String codigo, nome, idnivel;
        String[] colunas = new String[]{"Nome"};
        ArrayList dados = new ArrayList();
        boolean[] edicao = {false};
        while (c.next()) {
            codigo = c.fieldbyname("codigo");
            nome = c.fieldbyname("nome");
            idnivel = c.fieldbyname("nivel_idnivel");
    ...
    private void btnSelecionaRegistroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSelecionaRegistroActionPerformed
        ...
        if (jTable1.getRowCount() > 0 && jTable1.getSelectedRow() > -1) {
            ...
            int idnivel = Integer.parseInt(model.getRow(jTable1.getSelectedRow(), 2));
            for (Niveis nivel : new Niveis().carregar()) {
                if (nivel.getCodigo() == idnivel) {
                    cbNivel.getModel().setSelectedItem(nivel);
                }
            }
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        if (txtNome.getText().equals("")) {
            ...
            //Insere usando formatacao JAVA
            PreparedStatement st1 = null;
            String sqlInsert = "DELETE FROM login1 WHERE codigo=? ";
            try {
                st1 = banco.conn.prepareStatement(sqlInsert);
