 ...
 * @author MARK
 */
public class ifrmCadIdioma extends javax.swing.JInternalFrame {
...
//
//        try {
//            String sql = " SELECT MAX(Codigo)As Codigo FROM cadidiomas";
...
//        txtCodigo.setText(String.valueOf(max1 + 1));
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        if (txtNome.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "Preencha o campo Idioma !",
            ...
            String sqlInsert = "INSERT INTO cadidiomas(idioma)VALUES(?)";
            try {
            ...
            PreparedStatement st1 = null;
            String sqlInsert = "UPDATE cadidiomas SET idioma=? WHERE codigo=?";
            try {
                st1 = banco.conn.prepareStatement(sqlInsert);
                st1.setString(1, txtNome.getText().trim());
    ...
    private void txtConsultaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtConsultaKeyReleased
        ...
        if (rdAsc.isSelected() == true) {
            ...
            carregaArray.open("SELECT codigo,idioma FROM cadidiomas WHERE sem_acento(idioma) ILIKE'" + txtConsulta.getText().trim() + "%'"
                    + " ORDER BY cadidiomas ASC");
        } else {
            carregaArray.open("SELECT codigo,autor FROM cadidiomas WHERE sem_acento(idioma) ILIKE'" + txtConsulta.getText().trim() + "%'"
        ...
        while (carregaArray.next()) {
            ...
            gp = carregaArray.fieldbyname("idioma");


            idioma.setCodigo(Integer.parseInt(cod));
            idioma.setIdioma(gp);
            //Colocar os gets para poder funcionar corretamente
            vetor.add(new Idiomas(idioma.getCodigo(), idioma.getIdioma()));

        }

        String[] colunas = {"Idioma"};
        ...
        for (int x = 0; x < vetor.size(); x++) {
            ...
            modelo.setValueAt(((Idiomas) vetor.get(x)).getIdioma(), x, 0);
    ...
    private void btnTodosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTodosActionPerformed
        ...
        if (rdAsc.isSelected() == true) {
            //ILIKE é case insensitive para postgresql somente
            carregaArray.open("SELECT codigo,idioma FROM cadidiomas "
                    + " ORDER BY idioma ASC");
        } else {
            carregaArray.open("SELECT codigo,idioma FROM cadidiomas "
                    + " ORDER BY idioma DESC");
    ...
    private void btnSelecionaRegistroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSelecionaRegistroActionPerformed
        ...
        if (jTable1.getRowCount() > 0 && jTable1.getSelectedRow() > -1) {
            for (i = 0; i < vetor.size(); i++) {
                if (((Idiomas) vetor.get(i)).getIdioma().equals(jTable1.getModel().getValueAt(jTable1.getSelectedRow(), 0))) {
                    txtCodigo.setText(String.valueOf(((Idiomas) vetor.get(i)).getCodigo()));
...
//        }
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        if (txtNome.getText().equals("")) {
            ...
            //Insere usando formatacao JAVA
            PreparedStatement st1 = null;
            String sqlInsert = "DELETE FROM cadidiomas WHERE codigo=? ";
            try {
                st1 = banco.conn.prepareStatement(sqlInsert);
