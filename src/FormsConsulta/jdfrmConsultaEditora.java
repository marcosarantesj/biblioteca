 ...
 * @author MARK
 */
public class jdfrmConsultaEditora extends javax.swing.JDialog {
    ...
    public jdfrmConsultaEditora(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void txtConsultaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtConsultaKeyReleased
        ...
        carregaArray.open("SELECT codigo,editora FROM cadeditoras " +
                "WHERE sem_acento(editora) ILIKE'" + txtConsulta.getText().trim() + "%'"
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                jdfrmConsultaEditora dialog = new jdfrmConsultaEditora(new javax.swing.JFrame(), true);
