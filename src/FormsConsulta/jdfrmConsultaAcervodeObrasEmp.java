 ...
 * @author MARK
 */
public class jdfrmConsultaAcervodeObrasEmp extends javax.swing.JDialog {
    ...
    public jdfrmConsultaAcervodeObrasEmp(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Consulta Acervo de Obras-Empréstimos");
        setModal(true);
...
//------------------------------------------------------------------------------
        ...
        String sql = null;       
            sql="SELECT d.iddetalhesdolivro,d.exemplar,e.descricao,d.status,d.disponibilidade,d.cadlivros_id"
                ...
                + " AND d.disponibilidade='D' AND status='F'"
...
//------------------------------------------------------------------------------
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                jdfrmConsultaAcervodeObrasEmp dialog = new jdfrmConsultaAcervodeObrasEmp(new javax.swing.JFrame(), true);
