 ...
 * @author MARK
 */
public class jdfrmConsultaAutores extends javax.swing.JDialog {
    ...
    public jdfrmConsultaAutores(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                jdfrmConsultaAutores dialog = new jdfrmConsultaAutores(new javax.swing.JFrame(), true);
