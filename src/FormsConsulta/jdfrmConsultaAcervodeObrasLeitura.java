 ...
 * @author MARK
 */
public class jdfrmConsultaAcervodeObrasLeitura extends javax.swing.JDialog {
    ...
    public jdfrmConsultaAcervodeObrasLeitura(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Consulta Acervo de Obras-Leitura do Local");
        setModal(true);
...
//------------------------------------------------------------------------------
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                jdfrmConsultaAcervodeObrasLeitura dialog = new jdfrmConsultaAcervodeObrasLeitura(new javax.swing.JFrame(), true);
