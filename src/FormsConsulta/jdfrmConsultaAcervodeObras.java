 ...
 * @author MARK
 */
public class jdfrmConsultaAcervodeObras extends javax.swing.JDialog {
    ...
    public jdfrmConsultaAcervodeObras(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Consulta Acervo de Obras");
        setModal(true);
...
//        tblObras.getColumnModel().getColumn(7).setPreferredWidth(maxWidth7);
    ...
    private void btnSelecionaRegistroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSelecionaRegistroActionPerformed
        if (tblExemplares.isRowSelected(tblExemplares.getSelectedRow()) && okSelecionado == true) {
            this.dispose();
        }
...
//        }
    ...
    public String getTitulo() {
        Titulo = tblObras.getModel().getValueAt(tblObras.getSelectedRow(), 1).toString();
        return Titulo;
    }
...
//------------------------------------------------------------------------------
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                jdfrmConsultaAcervodeObras dialog = new jdfrmConsultaAcervodeObras(new javax.swing.JFrame(), true);
