 ...
 * @author MARK
 */
public class ifrmRelatorioTitulosMaisEmprestados extends javax.swing.JInternalFrame {

//    private DB banco;
    /** Creates new form ifrmRelatorioEmprestimos */
    public ifrmRelatorioTitulosMaisEmprestados() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Relação dos Títulos Mais Emprestados");
...
//Ler arquivo texto
    ...
    private void btnVisualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVisualizarActionPerformed
        ...
        if (rdPorPeriodo.isSelected() && chkTodos.isSelected() == false) {
            titulo = "Relação dos " + txtQtd.getText().trim() + " Títulos Mais Emprestados no Período de "
            ...
            //Mostra todos os livros devolvidos não importando a data e limitado em x livros
            titulo = "Relação Geral dos " + txtQtd.getText().trim() + " Títulos Mais Emprestados";
            sql = "SELECT c.titulo,COUNT(dl.cadlivros_id)AS total"
                    + " FROM detalhesmovimento dm,cadlivros c,detalhesdolivro dl"
                    + " WHERE dm.detalhesdolivro_id=dl.iddetalhesdolivro"
                    + " AND dl.cadlivros_id=c.codigo"
            ...
            //sem limite
            titulo = "Relação dos Títulos Mais Emprestados no Período de "
                    + txtDataInicial.getText().trim() + " a " + txtDataFinal.getText().trim();
            sql = "SELECT c.titulo,COUNT(dl.cadlivros_id)AS total"
                    + " FROM detalhesmovimento dm,cadlivros c,detalhesdolivro dl"
                    + " WHERE dm.detalhesdolivro_id=dl.iddetalhesdolivro"
            ...
            //Mostra todos os livros devolvidos não importando a data sem limite
            titulo = "Relação Geral dos Títulos Mais Emprestados";
            sql = "SELECT c.titulo,COUNT(dl.cadlivros_id)AS total"
                    + " FROM detalhesmovimento dm,cadlivros c,detalhesdolivro dl"
                    + " WHERE dm.detalhesdolivro_id=dl.iddetalhesdolivro"
                    + " AND dl.cadlivros_id=c.codigo"
