 ...
 * @author MARK
 */
public class ifrmEtiquetascomCodigodeBarras extends javax.swing.JInternalFrame {

    private Funcoes f = new Funcoes();
    private MkTableModel model;

    /** Creates new form ifrmCarteirinhadoLeitor */
    public ifrmEtiquetascomCodigodeBarras() {
        initComponents();
    }
...
//Ler arquivo texto
    ...
    private void btnGerarRelatorioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGerarRelatorioActionPerformed
        ...
        if (rdTodos.isSelected() == true) {
            sql = "SELECT d.iddetalhesdolivro id,d.exemplar ex,d.status s,"
                    + "c.cdc,c.cutter,b.nome biblioteca FROM detalhesdolivro d,"
                    + "cadlivros c,cadbiblioteca b "
                    + "WHERE d.cadlivros_id=c.codigo "
                    + "ORDER BY dl.iddetalhesdolivro ASC";
        } else {
            sql = "SELECT d.iddetalhesdolivro id,d.exemplar ex,d.status s,"
                    + "c.cdc,c.cutter,b.nome biblioteca FROM detalhesdolivro d,"
                    + "cadlivros c,cadbiblioteca b "
                    + "WHERE d.cadlivros_id=c.codigo"
                    + " AND d.iddetalhesdolivro IN (" + txtConsulta.getText().trim() + ")"
                    + " ORDER BY dl.iddetalhesdolivro ASC";
        }
        ...
        if (ok == true) {
            try {
                ...
                JasperPrint jp = JasperFillManager.fillReport(CaminhodoRelatorio() + "Etiquetas_pimaco3080_3180.jasper", parametros, banco.conn);
    ...
    private void formInternalFrameOpened(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameOpened
        ...
        txtCodInicial.setEnabled(false);
        txtCodFinal.setEnabled(false);
        String[] colunas = {"Código", "Título", "Exemplar"};
    ...
    private void btnAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdicionarActionPerformed
        if (txtCodInicial.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(null, "Digite o código inicial da Obra", "Mensagem", JOptionPane.INFORMATION_MESSAGE);
        } else if (txtCodFinal.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(null, "Digite o código final da Obra", "Mensagem", JOptionPane.INFORMATION_MESSAGE);
            ...
            for (int i = Integer.parseInt(txtCodInicial.getText().trim()); i <= Integer.parseInt(txtCodFinal.getText().trim()); i++) {
                for (Itens item : new Itens().carregar()) {
                    if (item.getCodigo() == i) {
                        model.addRow(new String[]{String.valueOf(i), item.getTitulo(), String.valueOf(item.getExemplar())});
        ...
        //----------------------------------------------------------------------
        if (txtConsulta.getText().trim().length() > 0 && !txtConsulta.getText().trim().equals("")) {
