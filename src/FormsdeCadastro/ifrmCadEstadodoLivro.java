 ...
 * @author MARK
 */
public class ifrmCadEstadodoLivro extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Cadastro de Estado de Conservação");
        ...
        jLabel2.setText("Estado de conservação:");
    ...
    private void btnAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdicionarActionPerformed
        ...
        try {
            String sql = " SELECT MAX(codigo)As Codigo FROM cadestadodolivro";
...
//        } finally {
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        if (txtNome.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "Preencha o campo Estado de Conservação !",
            ...
            String sqlInsert = "INSERT INTO cadestadodolivro(codigo,descricao)VALUES(?,?)";
            try {
            ...
            PreparedStatement st1 = null;
            String sqlInsert = "UPDATE cadestadodolivro SET descricao=? WHERE codigo=?";
            try {
                st1 = banco.conn.prepareStatement(sqlInsert);
    ...
    private void txtConsultaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtConsultaKeyReleased
        ...
        carregaArray.open("SELECT codigo,descricao FROM cadestadodolivro "
        ...
        String[] colunas = {"Estado de Conservação"};
...
//        }
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        if (txtNome.getText().equals("")) {
            ...
            //Insere usando formatacao JAVA
            PreparedStatement st1 = null;
            String sqlInsert = "DELETE FROM cadestadodolivro WHERE codigo=? ";
            try {
                st1 = banco.conn.prepareStatement(sqlInsert);
                st1.setInt(1, Integer.parseInt(txtCodigo.getText().trim()));
                //st1.setString(2, txtNome.getText().trim());
