 ...
 * @author MARK
 */
public class ifrmCadNiveldeEscolaridade extends javax.swing.JInternalFrame {

    private boolean novoCadastro;
    private DB banco2;
    private DefaultTableModel modelo;
    private ArrayList vetor;
    NiveldeEscolaridade nE;

    /** Creates new form ifrmCadAutores */
    public ifrmCadNiveldeEscolaridade() {
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Cadastro de Nível de Escolaridade");
    ...
    private void btnAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdicionarActionPerformed
        ...
        try {
            String sql = "SELECT MAX(Codigo) FROM niveldeescolaridade";
...
//        } finally {
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        if (txtNome.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "Preencha o campo Nível de Escolaridade !",
            ...
            String sqlInsert = "INSERT INTO niveldeescolaridade(codigo,descricao)VALUES(?,?)";
            try {
            ...
            PreparedStatement st1 = null;
            String sqlInsert = "UPDATE niveldeescolaridade SET descricao=? WHERE codigo=?";
            try {
                st1 = banco.conn.prepareStatement(sqlInsert);
    ...
    private void txtConsultaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtConsultaKeyReleased
        ...
        if(rdAsc.isSelected()==true){
         //ILIKE é case insensitive para postgresql somente
            carregaArray.open("SELECT codigo,descricao FROM niveldeescolaridade WHERE sem_acento(descricao) ILIKE'" + txtConsulta.getText().trim() + "%'"
        ...
        while (carregaArray.next()) {
            ...
            vetor.add(new NiveldeEscolaridade(nE.getCodigo(), nE.getDescricao()));
        }
        String[] colunas = {"Nível de Escolaridade"};
        ...
        for (int x = 0; x < vetor.size(); x++) {
            modelo.addRow(dados);    
            modelo.setValueAt(((NiveldeEscolaridade) vetor.get(x)).getDescricao(), x, 0);
        }
    ...
    private void btnTodosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTodosActionPerformed
        ...
        Query carregaArray = new Query(banco2.conn);
         ...
         if(rdAsc.isSelected()==true){
          //ILIKE é case insensitive para postgresql somente
            carregaArray.open("SELECT codigo,descricao FROM niveldeescolaridade "
                    + " ORDER BY descricao ASC");
         }else{
         //ILIKE é case insensitive para postgresql somente
            carregaArray.open("SELECT codigo,descricao FROM niveldeescolaridade "
    ...
    private void btnSelecionaRegistroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSelecionaRegistroActionPerformed
        ...
        if (jTable1.getRowCount() > 0 && jTable1.getSelectedRow() > -1) {
            for (i = 0; i < vetor.size(); i++) {
                if (((NiveldeEscolaridade) vetor.get(i)).getDescricao().equals(jTable1.getModel().getValueAt(jTable1.getSelectedRow(), 0))) {
                    txtCodigo.setText(String.valueOf(((NiveldeEscolaridade) vetor.get(i)).getCodigo()));
                }
            }
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        if (txtNome.getText().equals("")) {
            ...
            //Insere usando formatacao JAVA
            PreparedStatement st1 = null;
            String sqlInsert = "DELETE FROM niveldeescolaridade WHERE codigo=? ";
            try {
                st1 = banco.conn.prepareStatement(sqlInsert);
                st1.setInt(1, Integer.parseInt(txtCodigo.getText().trim()));
                //st1.setString(2, txtNome.getText().trim());
