 ...
 * @author MARK
 */
public class ifrmCadFormacaoAcademica extends javax.swing.JInternalFrame {
    ...
    public ifrmCadFormacaoAcademica() {
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Cadastro de Formação Acadêmica");
    ...
    private void btnAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdicionarActionPerformed
        ...
        try {
            String sql = "SELECT MAX(Codigo) FROM formacaoacademica";
...
//        } finally {
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        if (txtNome.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "Preencha o campo Formação Acadêmica !",
            ...
            String sqlInsert = "INSERT INTO formacaoacademica(codigo,descricao)VALUES(?,?)";
            try {
            ...
            PreparedStatement st1 = null;
            String sqlInsert = "UPDATE formacaoacademica SET descricao=? WHERE codigo=?";
            try {
                st1 = banco.conn.prepareStatement(sqlInsert);
    ...
    private void txtConsultaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtConsultaKeyReleased
        ...
        if(rdAsc.isSelected()==true){
         //ILIKE é case insensitive para postgresql somente
            carregaArray.open("SELECT codigo,descricao FROM formacaoacademica WHERE sem_acento(descricao) ILIKE'" + txtConsulta.getText().trim() + "%'"
        ...
        while (carregaArray.next()) {
            ...
            fA.setCodigo(Integer.parseInt(cod));
            fA.setDescricao(gp);
            //Colocar os gets para poder funcionar corretamente
            vetor.add(new FormacaoAcademica(fA.getCodigo(), fA.getDescricao()));
        }
        String[] colunas = {"Formação Acadêmica"};
        ...
        for (int x = 0; x < vetor.size(); x++) {
            modelo.addRow(dados);    
            modelo.setValueAt(((FormacaoAcademica) vetor.get(x)).getDescricao(), x, 0);
        }
    ...
    private void btnTodosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTodosActionPerformed
        ...
        Query carregaArray = new Query(banco2.conn);
         ...
         if(rdAsc.isSelected()==true){
          //ILIKE é case insensitive para postgresql somente
            carregaArray.open("SELECT codigo,descricao FROM formacaoacademica "
                    + " ORDER BY descricao ASC");
         }else{
         //ILIKE é case insensitive para postgresql somente
            carregaArray.open("SELECT codigo,descricao FROM formacaoacademica "
    ...
    private void btnSelecionaRegistroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSelecionaRegistroActionPerformed
        ...
        if (jTable1.getRowCount() > 0 && jTable1.getSelectedRow() > -1) {
            for (i = 0; i < vetor.size(); i++) {
                if (((FormacaoAcademica) vetor.get(i)).getDescricao().equals(jTable1.getModel().getValueAt(jTable1.getSelectedRow(), 0))) {
                    txtCodigo.setText(String.valueOf(((FormacaoAcademica) vetor.get(i)).getCodigo()));
                }
            }
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        if (txtNome.getText().equals("")) {
            ...
            //Insere usando formatacao JAVA
            PreparedStatement st1 = null;
            String sqlInsert = "DELETE FROM formacaoacademica WHERE codigo=? ";
            try {
                st1 = banco.conn.prepareStatement(sqlInsert);
                st1.setInt(1, Integer.parseInt(txtCodigo.getText().trim()));
                //st1.setString(2, txtNome.getText().trim());
